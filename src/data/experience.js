...
const getAllExperience = () => ([
  {
    ...
    imageUrl: cloudinary.url('Playstation-logo-colour_x3vi62.png', { quality: 'auto:best', width: 300, crop: 'scale' }),
  ...
  },
  {
    ...
    imageUrl: cloudinary.url('dexcom-green-category_joz2d8.jpg', { quality: 'auto:best', width: 300, crop: 'scale' }),
