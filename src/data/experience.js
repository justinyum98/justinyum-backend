...
const getAllExperience = () => ([
  {
    ...
    imageUrl: cloudinary.url('playstationlogo_inphb2.png', {radius: 30, width: 300, crop: "scale"}),
  ...
  },
  {
    ...
    imageUrl: cloudinary.url('dexcomlogo_rwctvv.jpg', {radius: 30, width: 300, crop: "scale"}),
